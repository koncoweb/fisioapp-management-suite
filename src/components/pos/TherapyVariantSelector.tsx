    ...
    <Card className="w-full">
      ...
      <CardContent>
        ...
        <RadioGroup
          ...
          className="space-y-3"
        >
          <label className="flex items-start space-x-3 space-y-0 rounded-md border p-3 cursor-pointer hover:bg-gray-50">
      ...
      <CardFooter className="flex justify-between border-t bg-gray-50/50 p-3">
